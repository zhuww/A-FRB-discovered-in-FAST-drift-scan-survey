...
{\bf Similar to the Figure 2 of \citet{hessels19}, the left panel shows the
...
The continued search of FRBs in FAST drift scan survey could lead to good
constraints on the true FRB event rate density \citep{lml+20} and put other
compact-object-merger FRB models, such as neutron star-neutron star merger model
(event rate density $\sim 2\times10^3$~Gpc$^{-3}$~yr$^{-1}$; \citealt{aaa+17}) to test \citep[see also][]{wang20}.
